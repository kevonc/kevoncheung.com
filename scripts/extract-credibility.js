...
const content = frontmatter + `Let's say there are two gardeners: John and Jenn.
...
// Write to file
const outputPath = path.join(__dirname, '../content/essays/credibility.md');
fs.writeFileSync(outputPath, content);

console.log('Content extracted and saved to content/essays/credibility.md'); 