...
description: "Learn why thinking too big can be detrimental to aspiring founders, and how to approach entrepreneurship with a more grounded mindset."
---\n\n`;

// The actual text content
const content = frontmatter + `I almost always say yes if an aspiring founder asks me for advice.
...
// Write to file
const outputPath = path.join(__dirname, '../content/essays/thinking-big.md');
fs.writeFileSync(outputPath, content);

console.log('Content extracted and saved to content/essays/thinking-big.md'); 